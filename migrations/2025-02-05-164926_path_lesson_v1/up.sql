...
DROP TABLE IF EXISTS path_segment;
...
CREATE TABLE path_segment (
    ...
    trainer_id INT,
    CONSTRAINT trainer_id_reference FOREIGN KEY (trainer_id) REFERENCES trainer (id),
    CONSTRAINT segment_parent_id_reference FOREIGN KEY (segment_parent_id) REFERENCES path_segment (id)
);

CREATE TABLE lesson (
  id SERIAL PRIMARY KEY,
  content TEXT NOT NULL,
  path_segment_id INT NOT NULL,
  CONSTRAINT path_segment_id_reference FOREIGN KEY (path_segment_id) REFERENCES path_segment (id)
);
